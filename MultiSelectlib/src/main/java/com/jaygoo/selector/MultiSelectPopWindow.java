...
public class MultiSelectPopWindow {
    ...
    public interface OnConfirmClickListener{
        void onClick(ArrayList<Integer> indexList, ArrayList<Site> selectedList);
    }

    static public class Builder{
        private Activity mActivity;
//        private ArrayList<String> choiceNameList = new ArrayList<>();
        private ArrayList<Site> choiceSiteList = new ArrayList<>();
...
//        }
        ...
        public Builder setArray(ArrayList<Site> list){
            this.choiceSiteList = list;
            return this;
        }
            ...
            public void onClick(View v) {
                if (mBuilder.mOnConfirmListener != null && mIndexList != null){
                    ...
                    for (int i = 0; i<mIndexList.size(); i++) {
                        siteList.add(mBuilder.choiceSiteList.get(mIndexList.get(i)));
                    }
                    mOnConfirmListener.onClick(mIndexList,siteList);
                }
                dismiss();
            }
        });
    ...
    private void initViews(View root) {
        ...
        adapter = new MultiSelectListAdapter(mBuilder.choiceSiteList);
