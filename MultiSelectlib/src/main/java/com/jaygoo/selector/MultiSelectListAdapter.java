...
public class MultiSelectListAdapter extends MultiChoiceAdapter<MultiSelectListAdapter.ChoiceViewHolder> {
    ...
    private ArrayList<Site> choiceSite = new ArrayList<>();
    ...
    public MultiSelectListAdapter(ArrayList<Site> list){
        choiceSite = list;

        //init the select state array
        if (choiceSite != null && choiceSite.size() >0) {
            selectStates = new Boolean[choiceSite.size()];
    ...
    public void onBindViewHolder(final ChoiceViewHolder holder, final int position) {
        ...
        // change the state
        boolean isVisible = selectStates[position];
        if(isVisible == true){
        ...
        holder.choiceNameBtn.setText(choiceSite.get(position).getName());
        ...
        holder.choiceNameBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mOnSelectAllListener != null){
                    ...
                    if (num == choiceSite.size() && choiceSite.size() >0){
