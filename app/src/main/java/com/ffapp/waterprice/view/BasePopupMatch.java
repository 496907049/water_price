...
public abstract class BasePopupMatch<T extends BasePopupMatch<T>> extends InternalBasePopupMatch<T> {
    protected View mWrappedView;
    protected LinearLayout mLlContent;
    protected boolean mAlignCenter;

    public BasePopupMatch(Context context) {
        super(context);
    ...
    public View onCreateView() {
        View inflate = View.inflate(mContext, R.layout.popup_base_match, null);
        mLlContent = (LinearLayout) inflate.findViewById(com.flyco.dialog.R.id.ll_content);
