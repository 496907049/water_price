...
public abstract class FullDialog<T> extends Dialog {
    /** mTag(日志) */
    ...
    public FullDialog(Context context, boolean isPopupStyle) {
        this(context);
...
//        LogUtil.i("mDisplayMetrics.heightPixels--->"+mDisplayMetrics.heightPixels);
//        LogUtil.i("StatusBarUtils.getHeight(mContext)--->"+StatusBarUtils.getHeight(mContext));
//        LogUtil.i("mDisplayMetrics.mMaxHeight--->"+mMaxHeight);

        mLlTop = new LinearLayout(mContext);
        mLlTop.setGravity(Gravity.CENTER);

        mLlControlHeight = new LinearLayout(mContext);
        mLlControlHeight.setLayoutParams(new ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,
                ViewGroup.LayoutParams.MATCH_PARENT));
        mLlControlHeight.setOrientation(LinearLayout.VERTICAL);

        mOnCreateView = onCreateView();
        mOnCreateView.setLayoutParams(new ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,
                ViewGroup.LayoutParams.MATCH_PARENT));
