...
public class PopFilterStatus extends BasePopup<PopFilterStatus> {
    ...
    public PopFilterStatus(Activity context, BaseListDataListBean listbean, FilterStatusListener listener) {
        super(context);
...
//        mListBean.getList().add(data);
    ...
    public View onCreatePopupView() {
        View inflate = LayoutInflater.from(mContext).inflate(R.layout.base_pop_view, null);
