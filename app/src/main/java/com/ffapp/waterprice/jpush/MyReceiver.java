...
import com.ffapp.waterprice.loading.LoadingActivity;
...
//                    extras.putSerializable("data", beanJ);
//                    openAppBundle(context, extras);
//                } else {
//                    openApp(context);
//                }
    ...
    private void openAppBundle(Context context, Bundle bundle) {
        LogUtil.i("--openAppBundle--》");
        Intent intent;
        if (!IntentUtils.isAppOnForeground(context)) {
            intent = new Intent(context, LoadingActivity.class);
            intent = IntentUtils.getAppIntentByPacagename(context, "com.ffapp");
            intent.putExtra("notify", bundle);
            context.startActivity(intent);
            ActivityTool.skipActivity(context, LoadingActivity.class, bundle);

//            openApp(context);
        } else {
            if (LoginBean.isLogin()) {
//				ActivityTool.skipActivity(context, AlarmDetailActivity.class,bundle);
            } else {
                openApp(context);
            }
        }
...
//        if (!IntentUtils.isAppOnForeground(context)) {
//            IntentUtils.openAppByPacagename(context, "com.ffapp");
//        }
    }
}
