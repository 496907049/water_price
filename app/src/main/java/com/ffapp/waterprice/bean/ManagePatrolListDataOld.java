...
public class ManagePatrolListDataOld extends BasisBean {
	...
	public BaseListDataListBean getListInfo(){
		...
		dataListBean.getList().add(new BaseListData(TimeUtils.getTimeLongToStrByFormat(begin_time,"yyyy-MM-dd HH:mm:ss"),"开始时间"));
	...
	public BaseListDataListBean getListInfoPatrol_Detail(){
		...
		dataListBean.getList().add(new BaseListData(TimeUtils.getTimeLongToStrByFormat(begin_time,"yyyy-MM-dd HH:mm:ss"),"巡检预计开始时间"));
		dataListBean.getList().add(new BaseListData(TimeUtils.getTimeLongToStrByFormat(end_time,"yyyy-MM-dd HH:mm:ss"),"巡检预计结束时间"));
		dataListBean.getList().add(new BaseListData(duty_person_name,"巡检人"));
		dataListBean.getList().add(new BaseListData(TimeUtils.getTimeLongToStrByFormat(begin_time,"yyyy-MM-dd HH:mm:ss"),"巡检起始时间"));
