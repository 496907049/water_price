...
public class WarnActivity extends BasisActivity {
...
//        mRecyclerView.setEmptyView(findViewById(R.id.refresh_view));
    ...
    public class MyAdapterList extends RecyclerView.Adapter<MyAdapterList.ViewHolder> {
        ...
        public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
            View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.data_warning, viewGroup, false);
        ...
        public class ViewHolder extends RecyclerView.ViewHolder {
            ...
            public void bind(int position) {
                ...
                tvWarnType.setText((listData.getWarningType() == null) ? "" : listData.getWarningType());
