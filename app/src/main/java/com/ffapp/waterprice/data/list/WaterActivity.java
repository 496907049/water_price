...
//        mRecyclerView.setLoadingMoreEnabled(false);
    ...
    private void getList() {
        ...
        String param = "{\"beginTime\":\"" + beginTime + "\",\"dateType\":\"" + dateType + "\",\"waterUser\":\"" + waterUserArr + "\",\"endTime\":\"" + endTime + "\"," +
    ...
    public class MyAdapterList extends RecyclerView.Adapter<MyAdapterList.ViewHolder> {
        ...
        public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
            View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.data_water, viewGroup, false);
        ...
        public class ViewHolder extends RecyclerView.ViewHolder {
            ...
            ImageView imgOnline;
            @BindView(R.id.tv_ratified_water_consumption)
            TextView tvRatifiedWaterConsumption;
            @BindView(R.id.tv_real_water_consumption)
            TextView tvRealWaterConsumption;
